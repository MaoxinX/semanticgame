...
var moneytime = 1;
var phase = 20 - moneytime; // 75 / 45 / 20 / 5
...
function gameSetup(data) {
    ...
    ***************************/
    ...
    // Show the instructions for the main task
        ...
        .attr('font-family', 'Arial')
        .attr('display', 'none')
        .text('You are now ready to begin the main task!');
...
function startTrial() {
    ...
    // Start the timer
    if (gamephase === 0) {
        svgContainer.select("#instrc1").attr("display", "block");
        svgContainer.select("#instrc2").attr("display", "block");
    }
...
function practicetrial() {
    svgContainer.select("#practice1").attr("display", "block");
...
function handleKeyPress(event) {
    if (event.key === 'Enter') {
        ...
        else if (gamephase === 3 && !categoryStarted) {
            svgContainer.select("#instruc3").attr("display", "none");
            svgContainer.select("#instruc2").attr("display", "none");
...
function startDelay() {
    ...
    if (trial === 3 || trial === 7 || trial === 12 || trial === 18 || trial === 21) {
        ...
        setTimeout(nextpractice, 1000 * phase);
    }
...
function nextpractice(){
    ...
    svgContainer.select("#attention").attr("display", "none");
    svgContainer.select("#fixation").attr("display", "none");
    svgContainer.select("#practice2").attr("display", "block");
    svgContainer.select("#enter").attr("display", "block");
    svgContainer.select("#score").attr("display", "block");
    svgContainer.select("#time").attr("display", "block");
    svgContainer.select("#total").attr("display", "block");
